...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      ...
      setError('Email service not configured. Please email us directly at catchingstarsinabucket@gmail.com');
    ...
    const templateParams = {
      ...
      to_email: 'catchingstarsinabucket@gmail.com'
    };
    ...
    try {
      ...
      setError('Failed to send message. Please try again or email us directly at catchingstarsinabucket@gmail.com');
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <div className="site-wrapper">
          ...
          <div className="header-right">
            ...
            <nav>
              <ul className={`main-navigation ${mobileMenuOpen ? 'mobile-open' : ''}`}>
                ...
                <li>
                  <Link to="/#author" onClick={() => setMobileMenuOpen(false)}>
                    About
                  </Link>
                </li>
                <li>
      ...
      <main className="main-content">
        <section className="content-section contact-page-section">
          <h2 className="contact-heading">Contact us</h2>
          <p className="contact-description">We'll be happy to hear your thoughts & feedback!</p>
          ...
          {submitted ? (
            <div className="contact-success">
              ...
              <p>Thank you for getting in touch! We'll respond to you as soon as possible.</p>
              <button onClick={() => setSubmitted(false)} className="go-back-button">
