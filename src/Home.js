...
function Home() {
  ...
  const trackPurchaseClick = (platform) => {
    if (window.gtag) {
            ...
            <div className="hero-text">
              ...
              <div className="purchase-buttons">
                <a
                  ...
                  onClick={() => trackPurchaseClick('Amazon')}
                >
                  <img
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="purchase-button"
                  onClick={() => trackPurchaseClick('Flipkart')}
                >
                  <img
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="purchase-button"
                  onClick={() => trackPurchaseClick('BookLeaf')}
                >
                  <img
        ...
        <div className="footer-content">
          ...
          <div className="social-links">
            ...
            <a
              ...
              onClick={() => trackSocialClick('Goodreads')}
            >
              <svg className="social-icon" viewBox="0 0 24 24">
